...
{
    public class LookupTreeAdapter : ComponentAdapterBase
    {
        public LookupTreeAdapter(LookupTreeModel componentModel)
        {
            ComponentModel = componentModel ?? throw new ArgumentNullException(nameof(componentModel));
            ComponentModel.ValueChanged += ComponentModel_ValueChanged;
        }
        public LookupTreeModel ComponentModel { get; }
        ...
        {
            ComponentModel.Value = (Category)value;
        }
        protected override RenderFragment CreateComponent()
        {
            return ComponentModelObserver.Create(ComponentModel, LookupTreeRenderer.Create(ComponentModel));
        }
