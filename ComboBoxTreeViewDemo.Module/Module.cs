...
namespace ComboBoxTreeViewDemo.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class ComboBoxTreeViewDemoModule : ModuleBase {
    public ComboBoxTreeViewDemoModule() {
		// 
		// ComboBoxTreeViewDemoModule
		// 
